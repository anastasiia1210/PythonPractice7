...
def read_file():
    ...
    """
    with open("/Users/lam/naukma/PythonBigData/project_template/app/io/input_file.txt", "r") as file:
        return file.read()
...
def read_file_pandas():
    ...
    """
    text = pd.read_csv("/Users/lam/naukma/PythonBigData/project_template/app/io/input_file.txt", sep='\t', header=None)
